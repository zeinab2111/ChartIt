 ...
 *   <li>{@link chartIt.impl.GraphDrawingImpl#getLabels <em>Labels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GraphDrawingImpl extends FunctionImpl implements GraphDrawing {
	...
	public EList<String> getLabels() {
		if (labels == null) {
			labels = new EDataTypeUniqueEList<String>(String.class, this, ChartItPackage.GRAPH_DRAWING__LABELS);
		}
		return labels;
	}
