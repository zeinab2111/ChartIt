...
import chartIt.mydsl.formatting2.MyDslFormatter;
import chartIt.mydsl.generator.MyDslGenerator;
import chartIt.mydsl.parser.antlr.MyDslAntlrTokenFileProvider;
import chartIt.mydsl.parser.antlr.MyDslParser;
import chartIt.mydsl.parser.antlr.internal.InternalMyDslLexer;
import chartIt.mydsl.scoping.MyDslScopeProvider;
import chartIt.mydsl.serializer.MyDslSemanticSequencer;
import chartIt.mydsl.serializer.MyDslSyntacticSequencer;
import chartIt.mydsl.services.MyDslGrammarAccess;
import chartIt.mydsl.validation.MyDslConfigurableIssueCodesProvider;
import chartIt.mydsl.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "chartIt/mydsl/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("chartIt.mydsl.MyDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("ext");
	}
