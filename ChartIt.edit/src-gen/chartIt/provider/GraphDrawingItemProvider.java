...
public class GraphDrawingItemProvider extends FunctionItemProvider {
	...
	protected void addLabelsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_GraphDrawing_labels_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_GraphDrawing_labels_feature",
								"_UI_GraphDrawing_type"),
						ChartItPackage.Literals.GRAPH_DRAWING__LABELS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case ChartItPackage.GRAPH_DRAWING__LABELS:
